...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TracingServiceCapabilities_protos_2fperfetto_2fcommon_2ftracing_5fservice_5fcapabilities_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_TracingServiceCapabilities_protos_2fperfetto_2fcommon_2ftracing_5fservice_5fcapabilities_2eproto}, {}};
...
void TracingServiceCapabilities::ArenaDtor(void* object) {
  TracingServiceCapabilities* _this = reinterpret_cast< TracingServiceCapabilities* >(object);
  (void)_this;
}
void TracingServiceCapabilities::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::PROTOBUF_NAMESPACE_ID::uint8* TracingServiceCapabilities::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(1, this->_internal_has_query_capabilities(), target);
  }
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(3, this->_internal_has_trace_config_output_path(), target);
  }

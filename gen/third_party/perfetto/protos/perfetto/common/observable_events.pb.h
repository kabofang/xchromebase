...
class ObservableEvents_DataSourceInstanceStateChange PROTOBUF_FINAL :
 ...
 public:
  ...
  void _internal_set_data_source_name(const std::string& value);
...
class ObservableEvents PROTOBUF_FINAL :
...
inline void ObservableEvents_DataSourceInstanceStateChange::clear_data_source_name() {
  data_source_name_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void ObservableEvents_DataSourceInstanceStateChange::set_data_source_name(const std::string& value) {
  _internal_set_data_source_name(value);
...
inline std::string* ObservableEvents_DataSourceInstanceStateChange::mutable_data_source_name() {
  ...
  return _internal_mutable_data_source_name();
}
...
inline void ObservableEvents_DataSourceInstanceStateChange::_internal_set_data_source_name(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  data_source_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void ObservableEvents_DataSourceInstanceStateChange::set_data_source_name(std::string&& value) {
  _has_bits_[0] |= 0x00000002u;
  data_source_name_.SetLite(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
...
inline void ObservableEvents_DataSourceInstanceStateChange::set_data_source_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  data_source_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void ObservableEvents_DataSourceInstanceStateChange::set_data_source_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  data_source_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* ObservableEvents_DataSourceInstanceStateChange::_internal_mutable_data_source_name() {
  _has_bits_[0] |= 0x00000002u;
  return data_source_name_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* ObservableEvents_DataSourceInstanceStateChange::release_data_source_name() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return data_source_name_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ObservableEvents_DataSourceInstanceStateChange::set_allocated_data_source_name(std::string* data_source_name) {
  ...
  data_source_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data_source_name,
      GetArena());
...
inline ::perfetto::protos::ObservableEvents_DataSourceInstanceStateChange* ObservableEvents::add_instance_state_changes() {
  ...
  return _internal_add_instance_state_changes();
}

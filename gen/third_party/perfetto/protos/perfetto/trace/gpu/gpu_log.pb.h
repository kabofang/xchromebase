...
class GpuLog PROTOBUF_FINAL :
 ...
 public:
  ...
  void _internal_set_log_message(const std::string& value);
...
inline void GpuLog::clear_log_message() {
  log_message_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void GpuLog::set_log_message(const std::string& value) {
  _internal_set_log_message(value);
...
inline const std::string& GpuLog::_internal_log_message() const {
  return log_message_.Get();
}
inline void GpuLog::_internal_set_log_message(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  log_message_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void GpuLog::set_log_message(std::string&& value) {
  _has_bits_[0] |= 0x00000002u;
  log_message_.SetLite(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
...
inline void GpuLog::set_log_message(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  log_message_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void GpuLog::set_log_message(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  log_message_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* GpuLog::_internal_mutable_log_message() {
  _has_bits_[0] |= 0x00000002u;
  return log_message_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* GpuLog::release_log_message() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return log_message_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void GpuLog::set_allocated_log_message(std::string* log_message) {
  ...
  log_message_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), log_message,
      GetArena());

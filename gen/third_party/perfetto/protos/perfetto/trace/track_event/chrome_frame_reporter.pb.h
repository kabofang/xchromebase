...
class ChromeFrameReporter PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_frame_source() const;
  void _internal_set_frame_source(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_frame_sequence() const;
  void _internal_set_frame_sequence(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_layer_tree_host_id() const;
  void _internal_set_layer_tree_host_id(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 ChromeFrameReporter::_internal_frame_source() const {
...
inline void ChromeFrameReporter::_internal_set_frame_source(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000004u;
  frame_source_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 ChromeFrameReporter::_internal_frame_sequence() const {
...
inline void ChromeFrameReporter::_internal_set_frame_sequence(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000008u;
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 ChromeFrameReporter::_internal_layer_tree_host_id() const {
...
inline void ChromeFrameReporter::_internal_set_layer_tree_host_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000200u;

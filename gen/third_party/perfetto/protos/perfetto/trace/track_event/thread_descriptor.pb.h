...
class ThreadDescriptor PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(ThreadDescriptor* other) {
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_reference_timestamp_us() const;
  void _internal_set_reference_timestamp_us(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_reference_thread_time_us() const;
  void _internal_set_reference_thread_time_us(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_reference_thread_instruction_count() const;
  void _internal_set_reference_thread_instruction_count(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
...
inline void ThreadDescriptor::_internal_set_thread_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  thread_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void ThreadDescriptor::set_thread_name(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  thread_name_.SetLite(
...
inline void ThreadDescriptor::set_thread_name(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  thread_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void ThreadDescriptor::set_thread_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  thread_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ThreadDescriptor::_internal_reference_timestamp_us() const {
...
inline void ThreadDescriptor::_internal_set_reference_timestamp_us(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000020u;
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ThreadDescriptor::_internal_reference_thread_time_us() const {
...
inline void ThreadDescriptor::_internal_set_reference_thread_time_us(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000040u;
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ThreadDescriptor::_internal_reference_thread_instruction_count() const {
...
inline void ThreadDescriptor::_internal_set_reference_thread_instruction_count(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000080u;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ThreadDescriptor::_internal_legacy_sort_index() const {
...
inline void ThreadDescriptor::_internal_set_legacy_sort_index(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000008u;

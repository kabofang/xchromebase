...
class ChromeLatencyInfo_ComponentInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(ChromeLatencyInfo_ComponentInfo* other) {
...
class ChromeLatencyInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(ChromeLatencyInfo* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_frame_tree_node_id() const;
  void _internal_set_frame_tree_node_id(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_gesture_scroll_id() const;
  void _internal_set_gesture_scroll_id(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_touch_id() const;
  void _internal_set_touch_id(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 ChromeLatencyInfo_ComponentInfo::_internal_time_us() const {
  return time_us_;
}
...
inline void ChromeLatencyInfo_ComponentInfo::_internal_set_time_us(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000001u;
  time_us_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ChromeLatencyInfo::_internal_trace_id() const {
  return trace_id_;
}
...
inline void ChromeLatencyInfo::_internal_set_trace_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000001u;
  trace_id_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ChromeLatencyInfo::_internal_frame_tree_node_id() const {
...
inline void ChromeLatencyInfo::_internal_set_frame_tree_node_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
...
inline ::perfetto::protos::ChromeLatencyInfo_ComponentInfo* ChromeLatencyInfo::add_component_info() {
  ...
  return _internal_add_component_info();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ChromeLatencyInfo::_internal_gesture_scroll_id() const {
...
inline void ChromeLatencyInfo::_internal_set_gesture_scroll_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000008u;
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ChromeLatencyInfo::_internal_touch_id() const {
  return touch_id_;
}
...
inline void ChromeLatencyInfo::_internal_set_touch_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000010u;
  touch_id_ = value;
}

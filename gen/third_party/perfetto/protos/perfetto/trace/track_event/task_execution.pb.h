...
class TaskExecution PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_posted_from_iid() const;
  void _internal_set_posted_from_iid(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 TaskExecution::_internal_posted_from_iid() const {
...
inline void TaskExecution::_internal_set_posted_from_iid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000001u;

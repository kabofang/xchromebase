...
class ChromeMessagePump PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_io_handler_location_iid() const;
  void _internal_set_io_handler_location_iid(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 ChromeMessagePump::_internal_io_handler_location_iid() const {
...
inline void ChromeMessagePump::_internal_set_io_handler_location_iid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000001u;

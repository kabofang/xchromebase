...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChromeMojoEventInfo_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fmojo_5fevent_5finfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ChromeMojoEventInfo_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fmojo_5fevent_5finfo_2eproto}, {}};
...
ChromeMojoEventInfo::ChromeMojoEventInfo(const ChromeMojoEventInfo& from)
  ...
  if (from._internal_has_watcher_notify_interface_tag()) {
    watcher_notify_interface_tag_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_watcher_notify_interface_tag(),
      GetArena());
  }
  mojo_interface_tag_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_mojo_interface_tag()) {
    mojo_interface_tag_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_mojo_interface_tag(),
      GetArena());
  }
...
void ChromeMojoEventInfo::SharedDtor() {
  ...
  mojo_interface_tag_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void ChromeMojoEventInfo::ArenaDtor(void* object) {
  ChromeMojoEventInfo* _this = reinterpret_cast< ChromeMojoEventInfo* >(object);
  (void)_this;
}
void ChromeMojoEventInfo::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::PROTOBUF_NAMESPACE_ID::uint8* ChromeMojoEventInfo::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000004u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(2, this->_internal_ipc_hash(), target);
  }
...
void ChromeMojoEventInfo::InternalSwap(ChromeMojoEventInfo* other) {
  ...
  watcher_notify_interface_tag_.Swap(&other->watcher_notify_interface_tag_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  mojo_interface_tag_.Swap(&other->mojo_interface_tag_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  swap(ipc_hash_, other->ipc_hash_);
}

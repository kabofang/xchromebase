...
class ChromeThreadDescriptor PROTOBUF_FINAL :
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ChromeThreadDescriptor::_internal_legacy_sort_index() const {
...
inline void ChromeThreadDescriptor::_internal_set_legacy_sort_index(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;

...
class LogMessage PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_body_iid() const;
  void _internal_set_body_iid(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
...
class LogMessageBody PROTOBUF_FINAL :
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 LogMessage::_internal_source_location_iid() const {
...
inline void LogMessage::_internal_set_source_location_iid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000001u;
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 LogMessage::_internal_body_iid() const {
  return body_iid_;
}
...
inline void LogMessage::_internal_set_body_iid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000002u;
  body_iid_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 LogMessageBody::_internal_iid() const {
  return iid_;
}
...
inline void LogMessageBody::_internal_set_iid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000002u;
  iid_ = value;
}
...
inline void LogMessageBody::_internal_set_body(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  body_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void LogMessageBody::set_body(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  body_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void LogMessageBody::set_body(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  body_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(

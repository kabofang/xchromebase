...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChromeLegacyIpc_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5flegacy_5fipc_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ChromeLegacyIpc_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5flegacy_5fipc_2eproto}, {}};
...
void ChromeLegacyIpc::SharedCtor() {
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&message_class_) - reinterpret_cast<char*>(this)),
      0, static_cast<size_t>(reinterpret_cast<char*>(&message_line_) -
      reinterpret_cast<char*>(&message_class_)) + sizeof(message_line_));
}
...
void ChromeLegacyIpc::ArenaDtor(void* object) {
  ChromeLegacyIpc* _this = reinterpret_cast< ChromeLegacyIpc* >(object);
  (void)_this;
}
void ChromeLegacyIpc::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          message_line_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* ChromeLegacyIpc::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(2, this->_internal_message_line(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.ChromeLegacyIpc)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000001u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->_internal_message_class());
    }
...
void ChromeLegacyIpc::InternalSwap(ChromeLegacyIpc* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ChromeLegacyIpc, message_line_)
      + sizeof(ChromeLegacyIpc::message_line_)
      - PROTOBUF_FIELD_OFFSET(ChromeLegacyIpc, message_class_)>(
          reinterpret_cast<char*>(&message_class_),
          reinterpret_cast<char*>(&other->message_class_));
}

...
class ChromeLegacyIpc PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(ChromeLegacyIpc* other) {
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_message_line() const;
  void _internal_set_message_line(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ChromeLegacyIpc::_internal_message_line() const {
...
inline void ChromeLegacyIpc::_internal_set_message_line(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
  message_line_ = value;
}

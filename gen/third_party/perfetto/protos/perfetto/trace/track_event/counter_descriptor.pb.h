...
inline void CounterDescriptor::_internal_set_unit_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  unit_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void CounterDescriptor::set_unit_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  unit_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void CounterDescriptor::set_unit_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  unit_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(

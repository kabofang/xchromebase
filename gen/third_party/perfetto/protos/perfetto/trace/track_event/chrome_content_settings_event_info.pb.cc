...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChromeContentSettingsEventInfo_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fcontent_5fsettings_5fevent_5finfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ChromeContentSettingsEventInfo_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fcontent_5fsettings_5fevent_5finfo_2eproto}, {}};
...
void ChromeContentSettingsEventInfo::ArenaDtor(void* object) {
  ChromeContentSettingsEventInfo* _this = reinterpret_cast< ChromeContentSettingsEventInfo* >(object);
  (void)_this;
}
void ChromeContentSettingsEventInfo::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          number_of_exceptions_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* ChromeContentSettingsEventInfo::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(1, this->_internal_number_of_exceptions(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.ChromeContentSettingsEventInfo)
  ...
  if (from._internal_has_number_of_exceptions()) {
    _internal_set_number_of_exceptions(from._internal_number_of_exceptions());
  }
}

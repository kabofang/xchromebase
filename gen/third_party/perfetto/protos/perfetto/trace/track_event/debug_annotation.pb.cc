...
class DebugAnnotationValueTypeNameDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<DebugAnnotationValueTypeName> _instance;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_DebugAnnotation_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_DebugAnnotation_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_DebugAnnotation_NestedValue_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_DebugAnnotation_NestedValue_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto}, {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_DebugAnnotationName_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_DebugAnnotationName_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto}, {}};

static void InitDefaultsscc_info_DebugAnnotationValueTypeName_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::perfetto::protos::_DebugAnnotationValueTypeName_default_instance_;
    new (ptr) ::perfetto::protos::DebugAnnotationValueTypeName();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_DebugAnnotationValueTypeName_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_DebugAnnotationValueTypeName_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto}, {}};
...
void DebugAnnotation_NestedValue::ArenaDtor(void* object) {
  DebugAnnotation_NestedValue* _this = reinterpret_cast< DebugAnnotation_NestedValue* >(object);
  (void)_this;
}
void DebugAnnotation_NestedValue::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::PROTOBUF_NAMESPACE_ID::uint8* DebugAnnotation_NestedValue::_InternalSerialize(
...
void DebugAnnotation::set_allocated_nested_value(::perfetto::protos::DebugAnnotation_NestedValue* nested_value) {
  ...
  if (nested_value) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(nested_value);
...
DebugAnnotation::DebugAnnotation(const DebugAnnotation& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      ...
      array_values_(from.array_values_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  proto_value_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_proto_value()) {
    proto_value_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_proto_value(),
      GetArena());
  }
...
void DebugAnnotation::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  proto_value_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (has_name_field()) {
    clear_name_field();
  }
  if (has_value()) {
...
void DebugAnnotation::ArenaDtor(void* object) {
  DebugAnnotation* _this = reinterpret_cast< DebugAnnotation* >(object);
  (void)_this;
}
void DebugAnnotation::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::PROTOBUF_NAMESPACE_ID::uint8* DebugAnnotation::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
    ...
    case kNestedValue: {
      ...
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(
          8, _Internal::nested_value(this), target, stream);
      break;
    }
    case kLegacyJsonValue: {
      target = stream->WriteStringMaybeAliased(
  ...
  // repeated .perfetto.protos.DebugAnnotation dict_entries = 11;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_dict_entries_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(11, this->_internal_dict_entries(i), target, stream);
  }
  ...
  for (unsigned int i = 0,
    ...
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(12, this->_internal_array_values(i), target, stream);
  }

  // uint64 proto_type_name_iid = 13;
  if (_internal_has_proto_type_name_iid()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(13, this->_internal_proto_type_name_iid(), target);
  }
...
void DebugAnnotation::InternalSwap(DebugAnnotation* other) {
  ...
  array_values_.InternalSwap(&other->array_values_);
  proto_value_.Swap(&other->proto_value_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
void DebugAnnotationName::ArenaDtor(void* object) {
  DebugAnnotationName* _this = reinterpret_cast< DebugAnnotationName* >(object);
  (void)_this;
}
void DebugAnnotationName::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::PROTOBUF_NAMESPACE_ID::uint8* DebugAnnotationName::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void DebugAnnotationValueTypeName::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_DebugAnnotationValueTypeName_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  iid_ = PROTOBUF_ULONGLONG(0);
}
...
void DebugAnnotationValueTypeName::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void DebugAnnotationValueTypeName::ArenaDtor(void* object) {
  DebugAnnotationValueTypeName* _this = reinterpret_cast< DebugAnnotationValueTypeName* >(object);
  (void)_this;
}
void DebugAnnotationValueTypeName::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void DebugAnnotationValueTypeName::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const DebugAnnotationValueTypeName& DebugAnnotationValueTypeName::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_DebugAnnotationValueTypeName_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fdebug_5fannotation_2eproto.base);
  return *internal_default_instance();
}
...
const char* DebugAnnotationValueTypeName::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* DebugAnnotationValueTypeName::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void DebugAnnotationValueTypeName::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const DebugAnnotationValueTypeName*>(
      &from));
}
...
template<> PROTOBUF_NOINLINE ::perfetto::protos::DebugAnnotationValueTypeName* Arena::CreateMaybeMessage< ::perfetto::protos::DebugAnnotationValueTypeName >(Arena* arena) {

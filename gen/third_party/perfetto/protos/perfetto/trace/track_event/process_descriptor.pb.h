...
class ProcessDescriptor PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(ProcessDescriptor* other) {
...
inline void ProcessDescriptor::_internal_set_process_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  process_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void ProcessDescriptor::set_process_name(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  process_name_.SetLite(
...
inline void ProcessDescriptor::set_process_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  process_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void ProcessDescriptor::set_process_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  process_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ProcessDescriptor::_internal_legacy_sort_index() const {
...
inline void ProcessDescriptor::_internal_set_legacy_sort_index(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
...
inline std::string* ProcessDescriptor::mutable_process_labels(int index) {
  ...
  return process_labels_.Mutable(index);
}
inline void ProcessDescriptor::set_process_labels(int index, const std::string& value) {
  ...
  process_labels_.Mutable(index)->assign(value);
}
inline void ProcessDescriptor::set_process_labels(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:perfetto.protos.ProcessDescriptor.process_labels)
  process_labels_.Mutable(index)->assign(std::move(value));
}
...
inline void ProcessDescriptor::set_process_labels(int index, const char* value, size_t size) {
  process_labels_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline void ProcessDescriptor::add_process_labels(std::string&& value) {
  process_labels_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:perfetto.protos.ProcessDescriptor.process_labels)
}
...
inline void ProcessDescriptor::add_process_labels(const char* value, size_t size) {
  process_labels_.Add()->assign(reinterpret_cast<const char*>(value), size);

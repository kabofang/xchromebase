...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChromeProcessDescriptor_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fprocess_5fdescriptor_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ChromeProcessDescriptor_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fprocess_5fdescriptor_2eproto}, {}};
...
ChromeProcessDescriptor::ChromeProcessDescriptor(const ChromeProcessDescriptor& from)
  ...
  if (from._internal_has_host_app_package_name()) {
    host_app_package_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_host_app_package_name(),
      GetArena());
  }
...
void ChromeProcessDescriptor::ArenaDtor(void* object) {
  ChromeProcessDescriptor* _this = reinterpret_cast< ChromeProcessDescriptor* >(object);
  (void)_this;
}
void ChromeProcessDescriptor::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::PROTOBUF_NAMESPACE_ID::uint8* ChromeProcessDescriptor::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_process_priority(), target);
  }
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(5, this->_internal_crash_trace_id(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.ChromeProcessDescriptor)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->_internal_process_type());
    }
...
void ChromeProcessDescriptor::InternalSwap(ChromeProcessDescriptor* other) {
  ...
  host_app_package_name_.Swap(&other->host_app_package_name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());

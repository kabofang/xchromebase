...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChromeThreadDescriptor_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fthread_5fdescriptor_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ChromeThreadDescriptor_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fthread_5fdescriptor_2eproto}, {}};
...
void ChromeThreadDescriptor::ArenaDtor(void* object) {
  ChromeThreadDescriptor* _this = reinterpret_cast< ChromeThreadDescriptor* >(object);
  (void)_this;
}
void ChromeThreadDescriptor::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::PROTOBUF_NAMESPACE_ID::uint8* ChromeThreadDescriptor::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_legacy_sort_index(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.ChromeThreadDescriptor)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000001u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->_internal_thread_type());
    }

...
class ClockSnapshot_Clock PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_clock_id() const;
  void _internal_set_clock_id(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_unit_multiplier_ns() const;
  void _internal_set_unit_multiplier_ns(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
...
class ClockSnapshot PROTOBUF_FINAL :
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ClockSnapshot_Clock::_internal_clock_id() const {
  return clock_id_;
}
...
inline void ClockSnapshot_Clock::_internal_set_clock_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
  clock_id_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 ClockSnapshot_Clock::_internal_timestamp() const {
  return timestamp_;
}
...
inline void ClockSnapshot_Clock::_internal_set_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000001u;
  timestamp_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 ClockSnapshot_Clock::_internal_unit_multiplier_ns() const {
...
inline void ClockSnapshot_Clock::_internal_set_unit_multiplier_ns(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000008u;

...
class Trigger PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_trusted_producer_uid() const;
  void _internal_set_trusted_producer_uid(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
...
inline void Trigger::_internal_set_trigger_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  trigger_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Trigger::set_trigger_name(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  trigger_name_.SetLite(
...
inline void Trigger::set_trigger_name(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  trigger_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void Trigger::set_trigger_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  trigger_name_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Trigger::_internal_trusted_producer_uid() const {
...
inline void Trigger::_internal_set_trusted_producer_uid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;

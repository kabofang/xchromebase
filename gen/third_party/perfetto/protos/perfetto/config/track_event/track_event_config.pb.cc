...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TrackEventConfig_protos_2fperfetto_2fconfig_2ftrack_5fevent_2ftrack_5fevent_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_TrackEventConfig_protos_2fperfetto_2fconfig_2ftrack_5fevent_2ftrack_5fevent_5fconfig_2eproto}, {}};
...
TrackEventConfig::TrackEventConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  disabled_categories_(arena),
  enabled_categories_(arena),
  disabled_tags_(arena),
  enabled_tags_(arena) {
  SharedCtor();
...
TrackEventConfig::TrackEventConfig(const TrackEventConfig& from)
  ...
  ::memcpy(&timestamp_unit_multiplier_, &from.timestamp_unit_multiplier_,
    static_cast<size_t>(reinterpret_cast<char*>(&enable_thread_time_sampling_) -
    reinterpret_cast<char*>(&timestamp_unit_multiplier_)) + sizeof(enable_thread_time_sampling_));
...
void TrackEventConfig::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&timestamp_unit_multiplier_) - reinterpret_cast<char*>(this)),
      0, static_cast<size_t>(reinterpret_cast<char*>(&enable_thread_time_sampling_) -
      reinterpret_cast<char*>(&timestamp_unit_multiplier_)) + sizeof(enable_thread_time_sampling_));
}
...
void TrackEventConfig::ArenaDtor(void* object) {
  TrackEventConfig* _this = reinterpret_cast< TrackEventConfig* >(object);
  (void)_this;
}
void TrackEventConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TrackEventConfig)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ::memset(&timestamp_unit_multiplier_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&enable_thread_time_sampling_) -
        reinterpret_cast<char*>(&timestamp_unit_multiplier_)) + sizeof(enable_thread_time_sampling_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          ...
          disable_incremental_timestamps_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          ...
          timestamp_unit_multiplier_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 56)) {
          ...
          filter_debug_annotations_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 64)) {
          ...
          enable_thread_time_sampling_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* TrackEventConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_disable_incremental_timestamps(), target);
  }

  // optional uint64 timestamp_unit_multiplier = 6;
  if (cached_has_bits & 0x00000001u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(6, this->_internal_timestamp_unit_multiplier(), target);
  }

  // optional bool filter_debug_annotations = 7;
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(7, this->_internal_filter_debug_annotations(), target);
  }

  // optional bool enable_thread_time_sampling = 8;
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(8, this->_internal_enable_thread_time_sampling(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.TrackEventConfig)
  ...
  // repeated string disabled_categories = 1;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(disabled_categories_.size());
  for (int i = 0, n = disabled_categories_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      disabled_categories_.Get(i));
  }

  // repeated string enabled_categories = 2;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(enabled_categories_.size());
  for (int i = 0, n = enabled_categories_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      enabled_categories_.Get(i));
  }

  // repeated string disabled_tags = 3;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(disabled_tags_.size());
  for (int i = 0, n = disabled_tags_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      disabled_tags_.Get(i));
  }

  // repeated string enabled_tags = 4;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(enabled_tags_.size());
  for (int i = 0, n = enabled_tags_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      enabled_tags_.Get(i));
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.TrackEventConfig)
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      timestamp_unit_multiplier_ = from.timestamp_unit_multiplier_;
    }
    if (cached_has_bits & 0x00000002u) {
      disable_incremental_timestamps_ = from.disable_incremental_timestamps_;
    }
    if (cached_has_bits & 0x00000004u) {
      filter_debug_annotations_ = from.filter_debug_annotations_;
    }
    if (cached_has_bits & 0x00000008u) {
      enable_thread_time_sampling_ = from.enable_thread_time_sampling_;
    }
...
void TrackEventConfig::InternalSwap(TrackEventConfig* other) {
  ...
  disabled_categories_.InternalSwap(&other->disabled_categories_);
  enabled_categories_.InternalSwap(&other->enabled_categories_);
  disabled_tags_.InternalSwap(&other->disabled_tags_);
  enabled_tags_.InternalSwap(&other->enabled_tags_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TrackEventConfig, enable_thread_time_sampling_)
      + sizeof(TrackEventConfig::enable_thread_time_sampling_)
      - PROTOBUF_FIELD_OFFSET(TrackEventConfig, timestamp_unit_multiplier_)>(
          reinterpret_cast<char*>(&timestamp_unit_multiplier_),
          reinterpret_cast<char*>(&other->timestamp_unit_multiplier_));
}

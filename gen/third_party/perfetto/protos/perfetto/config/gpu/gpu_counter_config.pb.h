...
class GpuCounterConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_counter_period_ns() const;
  void _internal_set_counter_period_ns(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 GpuCounterConfig::_internal_counter_period_ns() const {
...
inline void GpuCounterConfig::_internal_set_counter_period_ns(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000001u;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GpuCounterConfig::_internal_counter_ids(int index) const {
...
inline void GpuCounterConfig::_internal_add_counter_ids(::PROTOBUF_NAMESPACE_ID::uint32 value) {

...
class AndroidPowerConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_battery_poll_ms() const;
  void _internal_set_battery_poll_ms(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 AndroidPowerConfig::_internal_battery_poll_ms() const {
...
inline void AndroidPowerConfig::_internal_set_battery_poll_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000001u;

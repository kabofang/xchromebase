...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_AndroidPowerConfig_protos_2fperfetto_2fconfig_2fpower_2fandroid_5fpower_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_AndroidPowerConfig_protos_2fperfetto_2fconfig_2fpower_2fandroid_5fpower_5fconfig_2eproto}, {}};
...
void AndroidPowerConfig::ArenaDtor(void* object) {
  AndroidPowerConfig* _this = reinterpret_cast< AndroidPowerConfig* >(object);
  (void)_this;
}
void AndroidPowerConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::PROTOBUF_NAMESPACE_ID::uint8* AndroidPowerConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(1, this->_internal_battery_poll_ms(), target);
  }
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(3, this->_internal_collect_power_rails(), target);
  }

  // optional bool collect_energy_estimation_breakdown = 4;
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(4, this->_internal_collect_energy_estimation_breakdown(), target);
  }

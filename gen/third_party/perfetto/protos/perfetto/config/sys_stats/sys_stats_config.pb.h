...
class SysStatsConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_meminfo_period_ms() const;
  void _internal_set_meminfo_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_vmstat_period_ms() const;
  void _internal_set_vmstat_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_stat_period_ms() const;
  void _internal_set_stat_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_devfreq_period_ms() const;
  void _internal_set_devfreq_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 cpufreq_period_ms() const;
  void set_cpufreq_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_cpufreq_period_ms() const;
  void _internal_set_cpufreq_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 cpufreq_period_ms_;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 SysStatsConfig::_internal_meminfo_period_ms() const {
...
inline void SysStatsConfig::_internal_set_meminfo_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000001u;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 SysStatsConfig::_internal_vmstat_period_ms() const {
...
inline void SysStatsConfig::_internal_set_vmstat_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 SysStatsConfig::_internal_stat_period_ms() const {
...
inline void SysStatsConfig::_internal_set_stat_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000004u;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 SysStatsConfig::_internal_devfreq_period_ms() const {
...
inline void SysStatsConfig::_internal_set_devfreq_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000008u;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 SysStatsConfig::_internal_cpufreq_period_ms() const {
  return cpufreq_period_ms_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 SysStatsConfig::cpufreq_period_ms() const {
  // @@protoc_insertion_point(field_get:perfetto.protos.SysStatsConfig.cpufreq_period_ms)
  return _internal_cpufreq_period_ms();
}
inline void SysStatsConfig::_internal_set_cpufreq_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000010u;
  cpufreq_period_ms_ = value;
}
inline void SysStatsConfig::set_cpufreq_period_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {

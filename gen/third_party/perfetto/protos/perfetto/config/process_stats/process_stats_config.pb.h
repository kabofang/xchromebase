...
class ProcessStatsConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_proc_stats_poll_ms() const;
  void _internal_set_proc_stats_poll_ms(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_proc_stats_cache_ttl_ms() const;
  void _internal_set_proc_stats_cache_ttl_ms(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ProcessStatsConfig::_internal_proc_stats_poll_ms() const {
...
inline void ProcessStatsConfig::_internal_set_proc_stats_poll_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000004u;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ProcessStatsConfig::_internal_proc_stats_cache_ttl_ms() const {
...
inline void ProcessStatsConfig::_internal_set_proc_stats_cache_ttl_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000008u;

...
class JavaHprofConfig_ContinuousDumpConfig PROTOBUF_FINAL :
...
class JavaHprofConfig PROTOBUF_FINAL :
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 JavaHprofConfig_ContinuousDumpConfig::_internal_dump_phase_ms() const {
...
inline void JavaHprofConfig_ContinuousDumpConfig::_internal_set_dump_phase_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000001u;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 JavaHprofConfig_ContinuousDumpConfig::_internal_dump_interval_ms() const {
...
inline void JavaHprofConfig_ContinuousDumpConfig::_internal_set_dump_interval_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
...
inline bool JavaHprofConfig_ContinuousDumpConfig::_internal_scan_pids_only_on_start() const {
  return scan_pids_only_on_start_;
}
...
inline void JavaHprofConfig_ContinuousDumpConfig::_internal_set_scan_pids_only_on_start(bool value) {
  _has_bits_[0] |= 0x00000004u;
  scan_pids_only_on_start_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 JavaHprofConfig::_internal_pid(int index) const {
...
inline void JavaHprofConfig::_internal_add_pid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  pid_.Add(value);
}
...
inline ::perfetto::protos::JavaHprofConfig_ContinuousDumpConfig* JavaHprofConfig::_internal_mutable_continuous_dump_config() {
  ...
  if (continuous_dump_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::perfetto::protos::JavaHprofConfig_ContinuousDumpConfig>(GetArena());
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 JavaHprofConfig::_internal_min_anonymous_memory_kb() const {
...
inline void JavaHprofConfig::_internal_set_min_anonymous_memory_kb(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
...
inline std::string* JavaHprofConfig::add_ignored_types() {
  ...
  return _internal_add_ignored_types();
}
